...
SCRIPT_NAME="[create-docker-image-sample-word-vector-web-api-s3] :"
...
if [ "$(uname)" == 'Darwin' ] || [ "$(expr substr $(uname -s) 1 5)" == 'Linux' ]; then
    ...
    echo "${SCRIPT_NAME} cd ${BASEDIR}/../docker/sample_s3/"
    cd ${BASEDIR}/../docker/sample_s1/

    echo "${SCRIPT_NAME} docker build -t sample-word-vector-web-api-s3:v0.0.1"
